...
// This script moves the robot to its homing position
...
int main (int argc, char **argv) {
  ...
  joint_group_positions_arm[2] = -0.523598776; // -30 degrees in radians
  joint_group_positions_arm[3] = 0.00;
  joint_group_positions_arm[4] = -1.04719755; // -60 degrees in radians
